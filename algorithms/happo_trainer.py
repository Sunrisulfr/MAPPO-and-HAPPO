...
class HAPPO():
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        adv_targ, available_actions_batch, factor_batch, old_factor_batch = sample
        ...
        old_factor_batch = check(old_factor_batch).to(**self.tpdv)
        ...
        # surr2 = torch.clamp(imp_weights * factor_batch, 1.0 - self.clip_param, 1.0 + self.clip_param) * adv_targ
